...
import LoginCard from "@/app/(public)/(auth)/login/_components/login-card";

export const metadata: Metadata = {
  title: "Sarcia Rice Co. Login",
  description: "Customer login for ordering rice, tracking deliveries, and managing rewards.",
};
