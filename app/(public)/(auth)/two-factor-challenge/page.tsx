...
import TwoFactorChallengeCard from "@/app/(public)/(auth)/two-factor-challenge/_components/two-factor-challenge-card";

export const metadata: Metadata = {
  title: "Security Check | Sarcia Rice Co.",
  description:
    "Confirm a one-time security code before making a sensitive account change.",
};
