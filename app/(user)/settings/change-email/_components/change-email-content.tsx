...
export default function ChangeEmailContent() {
      ...
      if (!response.ok) {
        if (
          ...
          savePendingTwoFactorChallenge({
            purpose: data.purpose,
            method: data.two_factor_method,
            returnTo: "/settings/change-email",
            email: user?.email ?? "",
            mobile: user?.mobile ?? "",
            action: {
              type: "update_email",
  ...
  return (
    <CustomerShell
      subtitle="Keep your recovery and account notifications pointed to the right email."
      searchPlaceholder="Search email update or recovery help"
    >
      <div>
        <Link
          href="/settings"
        ...
        <div className="flex items-center gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[#6d7452]">
              Update your account email, then verify the new address before using it for recovery or 2FA.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#43612e]">
                    Your new email is saved. Please verify it from settings before using it for recovery or two-factor sign-in.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#e7e1c8] bg-[#faf7ee] p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#6d7452]">
                    Changing your email clears its verified status. You can verify the new address again from settings right after saving.
                  </p>
                </div>
              </div>
            </div>
