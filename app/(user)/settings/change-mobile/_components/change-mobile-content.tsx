...
export default function ChangeMobileContent() {
      ...
      if (!response.ok) {
        if (
          ...
          savePendingTwoFactorChallenge({
            purpose: data.purpose,
            method: data.two_factor_method,
            returnTo: "/settings/change-mobile",
            email: user?.email ?? "",
            mobile: user?.mobile ?? "",
            action: {
              type: "update_mobile",
  ...
  return (
    <CustomerShell
      subtitle="Keep OTP delivery and rider updates tied to the right mobile number."
      searchPlaceholder="Search mobile update or OTP help"
    >
      <div>
        <Link
          href="/settings"
        ...
        <div className="flex items-center gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[#6d7452]">
              Update the number used for OTP delivery, rider updates, and recovery follow-ups.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#43612e]">
                    Your new mobile number is saved. Please verify it from settings before using it for OTP or two-factor sign-in.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#e7e1c8] bg-[#faf7ee] p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#6d7452]">
                    Changing your mobile number clears its verified status. You can verify the new number again from settings after saving.
                  </p>
                </div>
              </div>
            </div>
