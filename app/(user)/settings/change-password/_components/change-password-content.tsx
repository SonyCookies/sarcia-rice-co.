...
export default function ChangePasswordContent() {
      ...
      if (!response.ok) {
        if (
          ...
          savePendingTwoFactorChallenge({
            purpose: data.purpose,
            method: data.two_factor_method,
            returnTo: "/settings/change-password",
            action: {
  ...
  return (
    <CustomerShell
      subtitle="Use a dedicated security page for credential updates and account protection."
      searchPlaceholder="Search password help or account security"
    >
      <div>
        <Link
          href="/settings"
          ...
          <div className="flex items-center gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-[#6d7452]">
                Confirm your current password, then choose a stronger one.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-[#43612e]">
                      Your new password is active now. You can head back to
                      settings or continue managing your account.
                    </p>
                  </div>
                </div>
              </div>
