...
const preferenceCards = [
  {
    ...
    title: "Email Admin Reminders",
    caption: "Receive admin-facing reminders, workflow follow-ups, and important operational updates by email.",
    icon: Mail,
  },
  {
    key: "email_account_alerts",
    title: "Email Security Alerts",
    caption: "Receive important security-related notices by email, including verification and admin account activity updates.",
    icon: ShieldCheck,
  },
  {
    key: "sms_delivery_updates",
    title: "SMS Urgent Admin Alerts",
    caption: "Receive urgent admin follow-ups and time-sensitive operational reminders on your mobile number.",
    icon: Workflow,
  },
  {
    key: "sms_security_alerts",
    title: "SMS Security Alerts",
    caption: "Receive time-sensitive security-related notices on your mobile number when an admin action needs attention.",
    icon: Smartphone,
  },
] as const;
...
export default function AdminAlertsNotificationsContent() {
  ...
  const pushCardDescription = pushStatus.isSubscribed
    ? "Admin reminders, security alerts, and important follow-ups can now appear directly on this device."
    : "Receive quick admin reminders, security alerts, and account-care notices directly from Sarcia Rice Co.";
  ...
  const pushHelperText = !pushStatus.isSupported
    ...
    : !pushStatus.isSecureContext
      ...
      : pushStatus.hasBrowserSubscription && !pushStatus.isSubscribed
        ? "This browser already has notification permission, but push is not yet turned on for this admin account. Turn it on below to link this device to your admin account."
  ...
  return (
    <AdminShell
      subtitle="Choose which admin reminders, security alerts, and browser push updates you want to receive."
      searchPlaceholder="Search admin alerts, notifications, or communication settings"
    >
      <div>
        <Link
          href="/admin/settings"
      ...
      <section className="rounded-[2rem] border border-[#ddd9c6] bg-white/92 p-5 shadow-[0_22px_50px_rgba(78,95,58,0.08)] sm:p-6">
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-[#6d7452]">
            Control which admin reminders, security alerts, and in-browser notices Sarcia Rice Co. sends to support your admin workflow.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-[#6d7452]">
                  Turn quick admin alerts on or off for this device.
                </p>
              </div>
            </div>
            <div
        ...
        <div className="mt-6 rounded-[1.6rem] border border-[#ddd7c4] bg-white/85 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-[#6d7452]">
                Turn on the admin updates you want to keep and switch off the ones you don&apos;t need right now.
              </p>
            </div>
          </div>
        </div>
